...
#define NODE_MAIN_LOGGER_NAME "pong"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpong_library.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<interactive_marker_tutorials::PongGameNode>";
